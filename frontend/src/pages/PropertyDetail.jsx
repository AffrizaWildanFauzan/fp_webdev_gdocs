      ...
      <div className="container-custom py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Gallery - PAKAI PROPERTYCAROUSEL */}
            <PropertyCarousel images={images} title={property.title} />

            {/* Description */}
            <div className="mt-8">
              <h2 className="font-heading text-2xl font-bold">Deskripsi</h2>
            ...
            <div className="mt-8">
              <h2 className="font-heading text-2xl font-bold mb-4">Lokasi</h2>
              <PropertyMap 
                properties={[property]} 
            ...
            {/* Specifications */}
            <div className="mt-8">
              <h2 className="font-heading text-2xl font-bold mb-4">Spesifikasi</h2>
            ...
            {property.facilities?.length > 0 && (
              <div className="mt-8">
                <h2 className="font-heading text-2xl font-bold mb-4">Fasilitas</h2>
                <div className="flex flex-wrap gap-2">
                  {property.facilities.map((facility, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 bg-gray-100 dark:bg-dark-700 rounded-full text-sm"
                    >
                      {facility}
                    </span>
                  ))}
            ...
            {/* Reviews - PAKAI REVIEWSYSTEM */}
            <div className="mt-8">
              <h2 className="font-heading text-2xl font-bold mb-4">Ulasan</h2>
              <ReviewSystem 
                propertyId={id} 
                reviews={reviews} 
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="card-shadow p-6">
                <div className="text-3xl font-bold text-primary-500">
                  ...
                  {property.status === 'sewa' && <span className="text-sm font-normal text-gray-500">/bulan</span>}
                </div>
              ...
              {/* Mortgage Calculator - PAKAI MORTGAGECALCULATOR */}
              <MortgageCalculator propertyPrice={property.price} />

              {/* Agent Info */}
              <div className="card-shadow p-6">
                <h3 className="font-heading text-lg font-bold mb-3">Agen Properti</h3>
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <div className="font-semibold">{property.agentId?.name || 'Agent'}</div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 py-3 rounded-lg border transition-colors ${
                      isWishlisted
                        ...
                        : 'border-gray-300 hover:border-primary-500 dark:border-dark-600'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 py-3 rounded-lg border border-gray-300 hover:border-primary-500 dark:border-dark-600 transition-colors"
                  >
                    <FaShare />
                    Bagikan
                  </button>
              ...
              {showInquiryForm && (
                ...
                >
                  <h4 className="font-semibold">Kirim Pertanyaan</h4>
                  <input
                    type="text"
                    placeholder="Nama"
                    value={inquiryData.name}
                    onChange={(e) => setInquiryData(prev => ({ ...prev, name: e.target.value }))}
                    className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg bg-transparent"
                    required
                  />
                  <input
                    type="email"
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 border border-gray-300 dark:border-dark-600 rounded-lg bg-transparent min-h-[100px]"
                    required
                  />
                  <button
                    type="submit"
